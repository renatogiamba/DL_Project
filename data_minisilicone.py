...
if __name__ == "__main__":
    ...
    train_ds.save_to_disk(
        "./hf/datasets/filtered/minisilicone/train", max_shard_size="2MB"
    )
    ...
    val_ds.save_to_disk(
        "./hf/datasets/filtered/minisilicone/validation", max_shard_size="2MB"
    )
    ...
    test_ds.save_to_disk(
        "./hf/datasets/filtered/minisilicone/test", max_shard_size="2MB"
    )
