...
if __name__ == "__main__":
    ...
    train_ds.save_to_disk(
        "./hf/datasets/filtered/stanford_sst2/train", max_shard_size="2MB"
    )
    ...
    val_ds.save_to_disk(
        "./hf/datasets/filtered/stanford_sst2/validation", max_shard_size="2MB"
    )
    ...
    test_ds.save_to_disk(
        "./hf/datasets/filtered/stanford_sst2/test", max_shard_size="2MB"
    )
